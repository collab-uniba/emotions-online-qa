...
public class Snowball {
	...
	public StringTokenizer split_words(String text){
		//int words     = 0;
	    //String delimiters = ".,':;?{}[]=-+_!@#$%^&*() ";
	...
	public String extract_stem(String input) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
	...
	public String extract_stem_corpus(String corpus) throws ClassNotFoundException, InstantiationException, IllegalAccessException{
