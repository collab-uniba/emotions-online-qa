...
class Readability:
    ...
    def getWordCount(self):
	   return self.analyzedVars['word_cnt']

    def getCharCount(self):
	   return self.analyzedVars['char_cnt']

    def getSentenceCount(self):
	   return self.analyzedVars['sentence_cnt']

    def getSyllableCount(self):
	   return self.analyzedVars['syllable_cnt']

    def getComplexWordsCount(self):
	   return self.analyzedVars['complex_word_cnt']

    def getAvgWordsPSentence(self):
	   return self.analyzedVars['avg_words_p_sentence']
...
if __name__ == "__main__":
    ...
    print 'LIX: ', rd.LIX()
    print 'RIX: ', rd.RIX()
    print 'NSentence', rd.getSentenceCount()
    print 'NWords', rd.getWordCount()
    print 'NChar', rd.getCharCount()
    print 'NSyllable', rd.getSyllableCount()
    print 'NComplexWords', rd.getComplexWordsCount()
    print 'AvgWOrdsPSentence', rd.getAvgWordsPSentence()		
